<template>
    <main class="space-y-6 mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <div class="flex justify-between items-center">
            <div class="">
                <h1 class="text-2xl font-semibold">Items from Just Spices</h1>
            </div>
        ...
        <div class="relative flex items-center justify-center ">
            ...
            <div class="flex overflow-hidden">
                <div class="flex transition-transform ease-in-out duration-500 gap-x-10"
                    ...
                    <div @click="addToCart(pair)" v-for="(pair, index) in pairs" :key="index" class="flex gap-x-10 justify-center min-w-full">
