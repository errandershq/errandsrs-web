      ...
      <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
        ...
        <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
          <div class="flex flex-col-reverse">
            <div class="mt-4">
              <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Egusi Soup with Pounded Yam</h1>
            ...
            <div>
              ...
              <div class="flex items-center">
                ...
                <svg class="text-gray-300 h-5 w-5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor"
                  aria-hidden="true">
                  <path fill-rule="evenodd"
                    d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z"
                    clip-rule="evenodd" />
          ...
          <p class="mt-6 text-gray-500">A hearty and flavorful soup made with melon seeds, vegetables, and spices,
            served with pounded yam.</p>
          ...
          <div class="mt-10 border-t border-gray-200 pt-10">
            ...
            <p class="mt-4 text-sm text-gray-500">For personal and professional use. You cannot resell or redistribute
              these icons in their original or modified state. <a href="#"
          ...
          <div>
            <div class="border-b border-gray-200">
              <div class="-mb-px flex space-x-8" aria-orientation="horizontal" role="tablist">
                ...
                <button @click="activeTab = 'reviews'" id="tab-reviews"
                  :class="[activeTab === 'reviews' ? 'border-b-2 border-gray-600' : '']"
                  class="border-transparent text-gray-700 whitespace-nowrap border-b-2 py-6 text-sm font-medium"
                  aria-controls="tab-panel-reviews" role="tab" type="button">Customer Reviews</button>
                <button @click="activeTab = 'faq'" id="tab-faq"
                  :class="[activeTab === 'faq' ? 'border-b-2 border-gray-600' : '']"
                  class="border-transparent text-gray-700 whitespace-nowrap border-b-2 py-6 text-sm font-medium"
                  aria-controls="tab-panel-faq" role="tab" type="button">FAQ</button>
                <button @click="activeTab = 'license'" id="tab-license"
                  :class="[activeTab === 'license' ? 'border-b-2 border-gray-600' : '']"
                  class="border-transparent text-gray-700 whitespace-nowrap border-b-2 py-6 text-sm font-medium"
            ...
            <div v-if="activeTab === 'reviews'" id="tab-panel-reviews" class="-mb-10" aria-labelledby="tab-reviews"
              ...
              <div class="flex space-x-4 text-sm text-gray-500">
                ...
                <div class="py-10">
                  ...
                  <div class="prose prose-sm mt-4 max-w-none text-gray-500">
                    <p>The Malian Maafe (Peanut Butter Stew) was an interesting dish. The peanut butter flavor was quite strong, which may not be for everyone. It was definitely a filling and hearty meal.</p>
                  </div>
                </div>
              </div>
              <div class="flex space-x-4 text-sm text-gray-500">
                ...
                <div class="py-10 border-t border-gray-200">
                  ...
                  <div class="prose prose-sm mt-4 max-w-none text-gray-500">
                    <p>The Tunisian Brik à l'Oeuf (Egg Pasty) was okay. The pastry was a bit greasy, and the egg filling could have been more flavorful</p>
                  </div>
                </div>
              </div>
            ...
            <div v-if="activeTab === 'faq'" id="tab-panel-faq" class="text-sm text-gray-500" aria-labelledby="tab-faq"
              role="tabpanel" tabindex="0">
              ...
              <dl>
                ...
                <dd class="prose prose-sm mt-2 max-w-none text-gray-500">
                  <p>The icons are in SVG (Scalable Vector Graphic) format. They can be imported into your design tool
                    of choice and used directly in code.</p>
                </dd>
                <dt class="mt-10 font-medium text-gray-900">Can I use the icons at different sizes?</dt>
                <dd class="prose prose-sm mt-2 max-w-none text-gray-500">
                  <p>Yes. The icons are drawn on a 24 x 24 pixel grid, but the icons can be scaled to different sizes as
                    needed. We don&#039;t recommend going smaller than 20 x 20 or larger than 64 x 64 to retain
            ...
            <div v-if="activeTab === 'license'" id="tab-panel-license" class="pt-10" aria-labelledby="tab-license"
              role="tabpanel" tabindex="0">
              ...
              <div class="prose prose-sm max-w-none text-gray-500">
                ...
                <p>For personal and professional use. You cannot resell or redistribute these icons in their original or
                  modified state.</p>
                ...
                <ul role="list">
                  <li>Don't be greedy. Selling or distributing these icons in their original or modified state is
                    prohibited.</li>
                  <li>Don't be evil. These icons cannot be used on websites or applications that promote illegal or
                    immoral beliefs or activities.</li>
                </ul>
              </div>
            </div>
          </div>
...
const handlePayment = () => {
  router.push('/resturant/checkout')
}
</script>