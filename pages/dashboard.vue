<template>
    <main class="relative isolate h-screen">
        ...
        <div class="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8">
            ...
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-white sm:text-5xl">Coming Soon</h1>
            <p class="mt-4 text-base text-white/70 sm:mt-6">Sorry, we couldn’t find the page you’re looking for.</p>
            <div class="mt-10 flex justify-center">
                <nuxt-link to="/" class="text-sm font-semibold leading-7 text-white"><span
